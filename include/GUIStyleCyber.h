...
static const GuiStyleProp cyberStyleProps[CYBER_STYLE_PROPS_COUNT] = {
    { 0, 0, static_cast<int>(0x2f7486ffULL) },    // DEFAULT_BORDER_COLOR_NORMAL
    { 0, 1, static_cast<int>(0x024658ffULL) },    // DEFAULT_BASE_COLOR_NORMAL
    { 0, 2, static_cast<int>(0x51bfd3ffULL) },    // DEFAULT_TEXT_COLOR_NORMAL
    { 0, 3, static_cast<int>(0x82cde0ffULL) },    // DEFAULT_BORDER_COLOR_FOCUSED
    { 0, 4, static_cast<int>(0x3299b4ffULL) },    // DEFAULT_BASE_COLOR_FOCUSED
    { 0, 5, static_cast<int>(0xb6e1eaffULL) },    // DEFAULT_TEXT_COLOR_FOCUSED
    { 0, 6, static_cast<int>(0xeb7630ffULL) },    // DEFAULT_BORDER_COLOR_PRESSED
    { 0, 7, static_cast<int>(0xffbc51ffULL) },    // DEFAULT_BASE_COLOR_PRESSED
    { 0, 8, static_cast<int>(0xd86f36ffULL) },    // DEFAULT_TEXT_COLOR_PRESSED
    { 0, 9, static_cast<int>(0x134b5affULL) },    // DEFAULT_BORDER_COLOR_DISABLED
    { 0, 10, static_cast<int>(0x02313dffULL) },    // DEFAULT_BASE_COLOR_DISABLED
    { 0, 11, static_cast<int>(0x17505fffULL) },    // DEFAULT_TEXT_COLOR_DISABLED
    { 0, 16, static_cast<int>(0x00000018ULL) },    // DEFAULT_TEXT_SIZE
    { 0, 17, static_cast<int>(0x00000000ULL) },    // DEFAULT_TEXT_SPACING
    { 0, 18, static_cast<int>(0x81c0d0ffULL) },    // DEFAULT_LINE_COLOR
    { 0, 19, static_cast<int>(0x00222bffULL) },    // DEFAULT_BACKGROUND_COLOR
};

// WARNING: This style uses a custom font:  (size: 18, spacing: 0)
